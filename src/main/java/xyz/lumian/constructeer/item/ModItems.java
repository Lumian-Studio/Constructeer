...
public final class ModItems
{
    ...
    static
    {
        ...
        WOODEN_SAW    = ModItems.createSaw("wooden",    ModItems.SAW_MATERIAL_WOOD,      5.5F, -4.2F);
        STONE_SAW     = ModItems.createSaw("stone",     ModItems.SAW_MATERIAL_STONE,     6.5F, -4.2F);
        COPPER_SAW    = ModItems.createSaw("copper",    ModItems.SAW_MATERIAL_COPPER,    6.5F, -4.2F);
        IRON_SAW      = ModItems.createSaw("iron",      ModItems.SAW_MATERIAL_IRON,      5.5F, -4.1F);
        GOLDEN_SAW    = ModItems.createSaw("golden",    ModItems.SAW_MATERIAL_GOLD,      5.5F, -4.0F);
        DIAMOND_SAW   = ModItems.createSaw("diamond",   ModItems.SAW_MATERIAL_DIAMOND,   4.5F, -4.0F);
        NETHERITE_SAW = ModItems.createSaw("netherite", ModItems.SAW_MATERIAL_NETHERITE, 4.5F, -4.0F);
